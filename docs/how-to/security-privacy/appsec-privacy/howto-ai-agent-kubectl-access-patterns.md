...
1. **Original Article:** Mike Anderson, "Your AI Agent Should Not Have Direct kubectl Access" — DEV.to, 2026-06-02. [Link](https://dev.to/mike_anderson_d01f52129fb/your-ai-agent-should-not-have-direct-kubectl-access-b1o)
2. **Kubernetes RBAC Documentation:** [Link](https://kubernetes.io/docs/reference/access-authn-authz/rbac/)
3. **Kubernetes Secrets Security Warning:** [Link](https://kubernetes.io/docs/concepts/configuration/secret/#security)
4. **OWASP LLM Top 10:** [Link](https://owasp.org/www-project-top-10-large-language-model-applications/)
5. **Kubernetes Pod Security Standards:** [Link](https://kubernetes.io/docs/concepts/security/pod-security-standards/)
6. **ValidatingAdmissionPolicy (Kubernetes v1.30+):** [Link](https://kubernetes.io/docs/reference/access-authn-authz/validating-admission-policy/)
7. **Kyverno Policy Engine:** [Link](https://kyverno.io/)
8. **OPA Gatekeeper:** [Link](https://openpolicyagent.github.io/gatekeeper/)
9. **OWASP AI Agent Security Cheat Sheet (2026):** [Link](https://cheatsheetseries.owasp.org/cheatsheets/AI_Agent_Security_Cheat_Sheet.html)
10. **Zylos AI Agent Sandboxing Research (2026):** [Link](https://zylos.ai/research/2026-04-04-ai-agent-sandboxing-security-isolation/)
11. **Kubernetes Agent Sandbox (k8s-sigs):** [Link](https://agent-sandbox.sigs.k8s.io/)
12. **Veracode 2025 AI-Generated Code Security Report:** [Link](https://www.veracode.com/)
