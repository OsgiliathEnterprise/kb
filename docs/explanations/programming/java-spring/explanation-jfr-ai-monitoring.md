...
JDK Flight Recorder captures detailed runtime diagnostics data (GC events, CPU usage, memory allocation, thread contention, safepoints, method compilation) with **less than 1% overhead** in production. Available since JDK 14 (GA in JDK 15).
